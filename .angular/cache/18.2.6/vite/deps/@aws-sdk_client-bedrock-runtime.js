...
var defaultBedrockRuntimeHttpAuthSchemeParametersProvider = (config, context, input) => __async(void 0, null, function* () {
  return {
...
(function(ConverseStreamOutput2) {
  ConverseStreamOutput2.visit = (value, visitor) => {
    ...
    if (value.internalServerException !== void 0) return visitor.internalServerException(value.internalServerException);
    if (value.modelStreamErrorException !== void 0) return visitor.modelStreamErrorException(value.modelStreamErrorException);
    ...
    if (value.serviceUnavailableException !== void 0) return visitor.serviceUnavailableException(value.serviceUnavailableException);
    return visitor._(value.$unknown[0], value.$unknown[1]);
  };
...
var ConverseStreamOutputFilterSensitiveLog = (obj) => {
  if (obj.messageStart !== void 0) return {
    messageStart: obj.messageStart
  };
  if (obj.contentBlockStart !== void 0) return {
    contentBlockStart: obj.contentBlockStart
  };
  if (obj.contentBlockDelta !== void 0) return {
    contentBlockDelta: obj.contentBlockDelta
  };
  if (obj.contentBlockStop !== void 0) return {
    contentBlockStop: obj.contentBlockStop
  };
  if (obj.messageStop !== void 0) return {
    messageStop: obj.messageStop
  };
  if (obj.metadata !== void 0) return {
    metadata: obj.metadata
  };
  if (obj.internalServerException !== void 0) return {
    internalServerException: obj.internalServerException
  };
  if (obj.modelStreamErrorException !== void 0) return {
    modelStreamErrorException: obj.modelStreamErrorException
  };
  if (obj.validationException !== void 0) return {
    validationException: obj.validationException
  };
  if (obj.throttlingException !== void 0) return {
    throttlingException: obj.throttlingException
  };
  if (obj.serviceUnavailableException !== void 0) return {
...
var ConverseStreamResponseFilterSensitiveLog = (obj) => __spreadValues(__spreadValues({}, obj), obj.stream && {
  stream: "STREAMING_CONTENT"
});
var InvokeModelRequestFilterSensitiveLog = (obj) => __spreadValues(__spreadValues({}, obj), obj.body && {
  body: SENSITIVE_STRING
});
var InvokeModelResponseFilterSensitiveLog = (obj) => __spreadValues(__spreadValues({}, obj), obj.body && {
  body: SENSITIVE_STRING
});
var InvokeModelWithResponseStreamRequestFilterSensitiveLog = (obj) => __spreadValues(__spreadValues({}, obj), obj.body && {
  body: SENSITIVE_STRING
});
var PayloadPartFilterSensitiveLog = (obj) => __spreadValues(__spreadValues({}, obj), obj.bytes && {
  bytes: SENSITIVE_STRING
});
var ResponseStreamFilterSensitiveLog = (obj) => {
  if (obj.chunk !== void 0) return {
    chunk: SENSITIVE_STRING
  };
  if (obj.internalServerException !== void 0) return {
    internalServerException: obj.internalServerException
  };
  ...
  if (obj.modelTimeoutException !== void 0) return {
...
var InvokeModelWithResponseStreamResponseFilterSensitiveLog = (obj) => __spreadValues(__spreadValues({}, obj), obj.body && {
  body: "STREAMING_CONTENT"
});

// node_modules/@aws-sdk/client-bedrock-runtime/dist-es/protocols/Aws_restJson1.js
var se_ApplyGuardrailCommand = (input, context) => __async(void 0, null, function* () {
...
var se_ConverseCommand = (input, context) => __async(void 0, null, function* () {
  const b2 = requestBuilder(input, context);
  const headers = {
    "content-type": "application/json"
  };
...
var se_ConverseStreamCommand = (input, context) => __async(void 0, null, function* () {
  const b2 = requestBuilder(input, context);
  const headers = {
    "content-type": "application/json"
  };
...
var se_InvokeModelCommand = (input, context) => __async(void 0, null, function* () {
  const b2 = requestBuilder(input, context);
...
var se_InvokeModelWithResponseStreamCommand = (input, context) => __async(void 0, null, function* () {
  const b2 = requestBuilder(input, context);
  const headers = map({}, isSerializableHeaderValue, {
    [_ct]: input[_cT] || "application/octet-stream",
    [_xaba]: input[_a],
...
var de_ApplyGuardrailCommand = (output, context) => __async(void 0, null, function* () {
...
var de_ConverseCommand = (output, context) => __async(void 0, null, function* () {
  if (output.statusCode !== 200 && output.statusCode >= 300) {
    return de_CommandError(output, context);
  }
  const contents = map({
...
var de_ConverseStreamCommand = (output, context) => __async(void 0, null, function* () {
  if (output.statusCode !== 200 && output.statusCode >= 300) {
    return de_CommandError(output, context);
  }
  const contents = map({
...
var de_InvokeModelCommand = (output, context) => __async(void 0, null, function* () {
  if (output.statusCode !== 200 && output.statusCode >= 300) {
    return de_CommandError(output, context);
  }
  const contents = map({
...
var de_InvokeModelWithResponseStreamCommand = (output, context) => __async(void 0, null, function* () {
  if (output.statusCode !== 200 && output.statusCode >= 300) {
    return de_CommandError(output, context);
  }
  const contents = map({
...
var de_CommandError = (output, context) => __async(void 0, null, function* () {
  ...
  switch (errorCode) {
    ...
    case "com.amazonaws.bedrockruntime#ModelErrorException":
      throw yield de_ModelErrorExceptionRes(parsedOutput, context);
    case "ModelNotReadyException":
    case "com.amazonaws.bedrockruntime#ModelNotReadyException":
      throw yield de_ModelNotReadyExceptionRes(parsedOutput, context);
    case "ModelTimeoutException":
    case "com.amazonaws.bedrockruntime#ModelTimeoutException":
      throw yield de_ModelTimeoutExceptionRes(parsedOutput, context);
    ...
    case "com.amazonaws.bedrockruntime#ModelStreamErrorException":
      throw yield de_ModelStreamErrorExceptionRes(parsedOutput, context);
    default:
...
var de_AccessDeniedExceptionRes = (parsedOutput, context) => __async(void 0, null, function* () {
  const contents = map({});
...
var de_InternalServerExceptionRes = (parsedOutput, context) => __async(void 0, null, function* () {
  const contents = map({});
  const data = parsedOutput.body;
  const doc = take(data, {
    message: expectString
...
var de_ModelErrorExceptionRes = (parsedOutput, context) => __async(void 0, null, function* () {
  const contents = map({});
  const data = parsedOutput.body;
  const doc = take(data, {
    message: expectString,
  ...
  Object.assign(contents, doc);
  const exception = new ModelErrorException(__spreadValues({
    $metadata: deserializeMetadata2(parsedOutput)
  }, contents));
  return decorateServiceException(exception, parsedOutput.body);
});
var de_ModelNotReadyExceptionRes = (parsedOutput, context) => __async(void 0, null, function* () {
  const contents = map({});
  const data = parsedOutput.body;
  const doc = take(data, {
    message: expectString
  ...
  Object.assign(contents, doc);
  const exception = new ModelNotReadyException(__spreadValues({
    $metadata: deserializeMetadata2(parsedOutput)
  }, contents));
  return decorateServiceException(exception, parsedOutput.body);
});
var de_ModelStreamErrorExceptionRes = (parsedOutput, context) => __async(void 0, null, function* () {
  const contents = map({});
  const data = parsedOutput.body;
  const doc = take(data, {
    message: expectString,
  ...
  Object.assign(contents, doc);
  const exception = new ModelStreamErrorException(__spreadValues({
    $metadata: deserializeMetadata2(parsedOutput)
  }, contents));
  return decorateServiceException(exception, parsedOutput.body);
});
var de_ModelTimeoutExceptionRes = (parsedOutput, context) => __async(void 0, null, function* () {
  const contents = map({});
  const data = parsedOutput.body;
  const doc = take(data, {
    message: expectString
  ...
  Object.assign(contents, doc);
  const exception = new ModelTimeoutException(__spreadValues({
    $metadata: deserializeMetadata2(parsedOutput)
  }, contents));
  return decorateServiceException(exception, parsedOutput.body);
});
...
var de_ServiceQuotaExceededExceptionRes = (parsedOutput, context) => __async(void 0, null, function* () {
  const contents = map({});
  const data = parsedOutput.body;
  const doc = take(data, {
    message: expectString
  ...
  Object.assign(contents, doc);
  const exception = new ServiceQuotaExceededException(__spreadValues({
    $metadata: deserializeMetadata2(parsedOutput)
  }, contents));
  return decorateServiceException(exception, parsedOutput.body);
});
var de_ServiceUnavailableExceptionRes = (parsedOutput, context) => __async(void 0, null, function* () {
  const contents = map({});
  const data = parsedOutput.body;
  const doc = take(data, {
    message: expectString
  ...
  Object.assign(contents, doc);
  const exception = new ServiceUnavailableException(__spreadValues({
    $metadata: deserializeMetadata2(parsedOutput)
  }, contents));
  return decorateServiceException(exception, parsedOutput.body);
});
var de_ThrottlingExceptionRes = (parsedOutput, context) => __async(void 0, null, function* () {
  const contents = map({});
  const data = parsedOutput.body;
  const doc = take(data, {
    message: expectString
  ...
  Object.assign(contents, doc);
  const exception = new ThrottlingException(__spreadValues({
    $metadata: deserializeMetadata2(parsedOutput)
  }, contents));
  return decorateServiceException(exception, parsedOutput.body);
});
...
var de_ConverseStreamOutput = (output, context) => {
  return context.eventStreamMarshaller.deserialize(output, (event) => __async(void 0, null, function* () {
    if (event["messageStart"] != null) {
      return {
        messageStart: yield de_MessageStartEvent_event(event["messageStart"], context)
      };
    }
    if (event["contentBlockStart"] != null) {
      return {
        contentBlockStart: yield de_ContentBlockStartEvent_event(event["contentBlockStart"], context)
      };
    }
    if (event["contentBlockDelta"] != null) {
      return {
        contentBlockDelta: yield de_ContentBlockDeltaEvent_event(event["contentBlockDelta"], context)
      };
    }
    if (event["contentBlockStop"] != null) {
      return {
        contentBlockStop: yield de_ContentBlockStopEvent_event(event["contentBlockStop"], context)
      };
    }
    if (event["messageStop"] != null) {
      return {
        messageStop: yield de_MessageStopEvent_event(event["messageStop"], context)
      };
    }
    if (event["metadata"] != null) {
      return {
        metadata: yield de_ConverseStreamMetadataEvent_event(event["metadata"], context)
      };
    }
    ...
    if (event["modelStreamErrorException"] != null) {
      return {
        modelStreamErrorException: yield de_ModelStreamErrorException_event(event["modelStreamErrorException"], context)
      };
    }
...
var de_ResponseStream = (output, context) => {
  return context.eventStreamMarshaller.deserialize(output, (event) => __async(void 0, null, function* () {
    if (event["chunk"] != null) {
      return {
        chunk: yield de_PayloadPart_event(event["chunk"], context)
      };
    }
    if (event["internalServerException"] != null) {
      return {
    ...
    if (event["modelTimeoutException"] != null) {
      return {
        modelTimeoutException: yield de_ModelTimeoutException_event(event["modelTimeoutException"], context)
      };
    }
    if (event["serviceUnavailableException"] != null) {
      return {
...
var de_ContentBlockDeltaEvent_event = (output, context) => __async(void 0, null, function* () {
  const contents = {};
  const data = yield parseJsonBody(output.body, context);
  Object.assign(contents, _json(data));
  return contents;
});
var de_ContentBlockStartEvent_event = (output, context) => __async(void 0, null, function* () {
  const contents = {};
  const data = yield parseJsonBody(output.body, context);
  Object.assign(contents, _json(data));
  return contents;
});
var de_ContentBlockStopEvent_event = (output, context) => __async(void 0, null, function* () {
  const contents = {};
  const data = yield parseJsonBody(output.body, context);
  Object.assign(contents, _json(data));
  return contents;
});
var de_ConverseStreamMetadataEvent_event = (output, context) => __async(void 0, null, function* () {
  const contents = {};
  const data = yield parseJsonBody(output.body, context);
  Object.assign(contents, de_ConverseStreamMetadataEvent(data, context));
  return contents;
});
var de_InternalServerException_event = (output, context) => __async(void 0, null, function* () {
  const parsedOutput = __spreadProps(__spreadValues({}, output), {
    body: yield parseJsonBody(output.body, context)
  });
  return de_InternalServerExceptionRes(parsedOutput, context);
});
var de_MessageStartEvent_event = (output, context) => __async(void 0, null, function* () {
  const contents = {};
  const data = yield parseJsonBody(output.body, context);
  Object.assign(contents, _json(data));
  return contents;
});
var de_MessageStopEvent_event = (output, context) => __async(void 0, null, function* () {
  const contents = {};
  const data = yield parseJsonBody(output.body, context);
  Object.assign(contents, de_MessageStopEvent(data, context));
  return contents;
});
var de_ModelStreamErrorException_event = (output, context) => __async(void 0, null, function* () {
  const parsedOutput = __spreadProps(__spreadValues({}, output), {
    body: yield parseJsonBody(output.body, context)
  });
  return de_ModelStreamErrorExceptionRes(parsedOutput, context);
});
var de_ModelTimeoutException_event = (output, context) => __async(void 0, null, function* () {
  const parsedOutput = __spreadProps(__spreadValues({}, output), {
    body: yield parseJsonBody(output.body, context)
  });
  return de_ModelTimeoutExceptionRes(parsedOutput, context);
});
var de_PayloadPart_event = (output, context) => __async(void 0, null, function* () {
  const contents = {};
  const data = yield parseJsonBody(output.body, context);
  Object.assign(contents, de_PayloadPart(data, context));
  return contents;
});
var de_ServiceUnavailableException_event = (output, context) => __async(void 0, null, function* () {
  const parsedOutput = __spreadProps(__spreadValues({}, output), {
    body: yield parseJsonBody(output.body, context)
  });
  return de_ServiceUnavailableExceptionRes(parsedOutput, context);
});
var de_ThrottlingException_event = (output, context) => __async(void 0, null, function* () {
  const parsedOutput = __spreadProps(__spreadValues({}, output), {
    body: yield parseJsonBody(output.body, context)
  });
  return de_ThrottlingExceptionRes(parsedOutput, context);
});
var de_ValidationException_event = (output, context) => __async(void 0, null, function* () {
  const parsedOutput = __spreadProps(__spreadValues({}, output), {
    body: yield parseJsonBody(output.body, context)
  });
